...
describe("TESTS", () => {
    ...
    it('shouled the componet renders one cell with colspan =2 when the textFirstCell does not exist', () => {
        ...
        expect(wrapper.contains(<tr><th colSpan={2}>{props.textFirstCell}</th></tr>)).equal(false);
    });
    ...
    it('shouled the componet renders 2 cells when textSecondCell is prensent', () => {
        ...
        const wrapper = shallow(<CourseListRow {...props} />);
        expect(wrapper.contains(<tr><th>{props.textFirstCell}</th><th>{props.textSecondCell}</th></tr>)).equal(false);
    });
    ...
    it('shouled the componet renders correctly 2 td elements within tr element', () =>{
        ...
        const wrapper = shallow(<CourseListRow {...props} />);
        expect(wrapper.contains(<tr><td>{props.textFirstCell}</td><td>{props.textSecondCell}</td></tr>)).equal(false);
    });
});
